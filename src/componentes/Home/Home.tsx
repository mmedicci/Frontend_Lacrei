    ...
    return (
        <div className="Home"> 
            ...
            <div className="Button">                  
                <button onClick={() => navigate("/PessoaUsuaria")} className="Button__dark"> Pessoa Usuária </button>                
                <button onClick={() => navigate("/Profissional")} className="Button__ligth"> Profissional </button>   
            </div> 
            <div className="Image">
